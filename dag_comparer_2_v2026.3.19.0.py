...
class Config:
    ...
    # INPUT_DIR = './CoT_judge/output_minicpm'
    # OUTPUT_DIR = "./CoT_judge/output_minicpm"
    # CHUNKS_DIR = "./CoT_chunks_node_score/output_minicpm"

    # INPUT_DIR = './CoT_judge_deepseek/output_minicpm'
    # OUTPUT_DIR = "./CoT_judge_deepseek/output_minicpm"
    # CHUNKS_DIR = "./CoT_chunks_node_score_deepseek/output_minicpm"

    INPUT_DIR = './CoT_judge_deepseek_reasoner/output_minicpm'
    OUTPUT_DIR = "./CoT_judge_deepseek_reasoner/output_minicpm"
    CHUNKS_DIR = "./CoT_chunks_node_score_deepseek_reasoner/output_minicpm"
